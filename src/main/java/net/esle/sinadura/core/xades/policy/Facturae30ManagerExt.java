...
import es.mityc.javasign.xml.xades.policy.facturae.Facturae30Manager;


public class Facturae30ManagerExt extends Facturae30Manager {
	
	private static final Log LOG = LogFactory.getLog(Facturae30ManagerExt.class);
	 ...
	 */
	public Facturae30ManagerExt() throws InstantiationException {
		
		LOG.info("cargando Facturae30ManagerExt");
